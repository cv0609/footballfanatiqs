    ...
    <div class="profile-sec">
        <div class="user-img">
            <div class="update_img_user">
                ...
                <img src="{{(!empty(Auth::user()->image)) ? asset(Auth::user()->image) : asset('assets/images/dummy.png') }}" alt="user_img">
                </div>
        ...
        <div class="edit_option_bar">
            ...
            <div class="content-bar">
                <a href="{{ route('profile.change.password') }}" class="tabedit">Update Password</a>
            </div>
        </div>
    </div>
</div>
